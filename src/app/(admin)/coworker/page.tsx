...
export default function CoworkerPlaceholder() {
  return (
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <div className="bg-amber-50 dark:bg-amber-950/20 border border-amber-200 dark:border-amber-900/60 rounded-xl p-4 mb-8 text-sm text-amber-800 dark:text-amber-300 flex items-start gap-3">
        ...
        <div>
          ...
          <p className="mt-1 opacity-90">
            Ứng dụng này hiện chưa được cấu hình khóa API hoặc tích hợp cơ sở dữ liệu. Vui lòng liên hệ quản trị viên để thiết lập tài khoản AI.
          </p>
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-[#1e1e2d] border border-gray-200 dark:border-gray-800 rounded-2xl p-6 md:p-8">
        <div className="text-center py-12 border-2 border-dashed border-gray-200 dark:border-gray-800 rounded-xl mb-8">
          ...
          <h3 className="text-lg font-bold text-gray-800 dark:text-white mb-2">Không có cuộc hội thoại nào</h3>
          <p className="text-sm text-gray-500 dark:text-gray-400 max-w-sm mx-auto">
            Hộp thoại trống. Sau khi kết nối tác vụ AI, bạn sẽ có thể tương tác trực tiếp với Coworker để tự động hóa công việc.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              "Giao diện trò chuyện AI trực quan điều khiển hành động",
              "Chạy nhanh các kịch bản (Playbooks) SEO & Content Audit",
              "Lập lịch chạy báo cáo định kỳ tự động hóa",
              "Kết nối Google Search Console & Google Business Profile"
            ].map((feature, i) => (
