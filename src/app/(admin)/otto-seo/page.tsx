...
export default function OttoSeoPlaceholder() {
  return (
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <div className="bg-amber-50 dark:bg-amber-950/20 border border-amber-200 dark:border-amber-900/60 rounded-xl p-4 mb-8 text-sm text-amber-800 dark:text-amber-300 flex items-start gap-3">
        ...
        <div>
          ...
          <p className="mt-1 opacity-90">
            Hệ thống tự động hóa SEO chưa được kết nối với Google Search Console hoặc domain của bạn. Hãy tạo dự án để bắt đầu.
          </p>
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-[#1e1e2d] border border-gray-200 dark:border-gray-800 rounded-2xl p-6 md:p-8">
        <div className="text-center py-12 border-2 border-dashed border-gray-200 dark:border-gray-800 rounded-xl mb-8">
          ...
          <h3 className="text-lg font-bold text-gray-800 dark:text-white mb-2">Không có dự án SEO nào</h3>
          <p className="text-sm text-gray-500 dark:text-gray-400 max-w-sm mx-auto">
            Chưa có dự án giám sát crawl hoặc tối ưu hóa nào được thiết lập. Nhấp vào "Tạo dự án mới" để bắt đầu theo dõi domain của bạn.
          </p>
          <button className="mt-4 inline-flex items-center justify-center px-4 py-2 rounded-lg text-xs font-bold bg-gray-100 dark:bg-gray-800 text-gray-400 cursor-not-allowed border border-gray-200 dark:border-gray-700 pointer-events-none">
            + Tạo dự án mới
          </button>
        </div>
        ...
        <div>
          ...
          <ul className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              "Cấu hình dự án SEO tự động hóa cho nhiều domain",
              "Bảng điều khiển các nhiệm vụ (Tasks) cần xử lý",
              "Hướng dẫn cài đặt mã theo dõi và crawl script",
              "Theo dõi tần suất bot crawl và phát hiện link hỏng live"
            ].map((feature, i) => (
