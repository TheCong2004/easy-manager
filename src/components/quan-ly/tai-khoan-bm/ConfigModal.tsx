...
interface ConfigModalProps {
  ...
  setSourceType: (type: "all" | "by-id") => void;
        ...
        <div className="flex items-center justify-between px-6 py-4.5 border-b border-gray-150 dark:border-gray-800">
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col text-left">
              <h3 className="text-sm sm:text-base font-bold text-gray-900 dark:text-white">Cấu hình tải dữ liệu BM</h3>
              <span className="text-[10px] sm:text-xs text-gray-400">Thiết lập nguồn dữ liệu và tùy chọn trước khi tải Business Manager.</span>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-6 flex flex-col gap-5 overflow-y-auto max-h-[60vh] text-left">
          ...
          <div>
            <div className="flex items-center gap-2.5 mb-2.5 select-none">
              <input
                ...
                className="rounded text-blue-600 focus:ring-blue-500 w-4.5 h-4.5 cursor-pointer"
              />
              <label htmlFor="adv-config-bm" className="text-xs font-bold uppercase tracking-wider text-gray-400 cursor-pointer">
            ...
            {advancedConfig && (
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                {[
                  ...
                  <label
                    key={opt.key}
                    className="flex items-start gap-2.5 p-3 bg-gray-50/50 hover:bg-gray-50 dark:bg-gray-900/40 dark:hover:bg-gray-900 border border-gray-150 dark:border-gray-800 rounded-xl cursor-pointer select-none transition"
                  >
                    <input
                      type="checkbox"
          ...
          <div className="flex flex-wrap items-center justify-between gap-4 p-4.5 bg-gray-50/50 dark:bg-gray-900/30 border border-gray-150 dark:border-gray-800 rounded-xl">
            <div className="flex flex-col text-left">
              ...
              <span className="text-[10px] text-gray-400 mt-0.5">Số lượng BM tối đa mỗi lần gọi API phân trang</span>
            </div>
            <input
              type="number"
              value={limitApi}
