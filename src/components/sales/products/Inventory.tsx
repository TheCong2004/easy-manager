        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="border-b border-gray-150 dark:border-gray-850 bg-gray-50/50 dark:bg-gray-800/10">
              ...
              <th className="py-3.5 px-5 text-xs font-bold text-blue-600 cursor-pointer select-none hover:text-blue-700 transition">
                Số lượng
                <svg className="inline-block w-3 h-3 ml-0.5 text-blue-500" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
